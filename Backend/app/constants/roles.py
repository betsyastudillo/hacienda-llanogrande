...
CAN_VIEW_PAYMENTS_ALL = (ADMIN, CARTERA, SOPORTE, CLIENT_ROLES)

# Ver todas las guías de despacho
CAN_VIEW_DISPATCH_GUIDES = (ADMIN, OPERACIONES, LOGISTICA, SOPORTE, CLIENT_ROLES)

# Modificar usuarios
CAN_MANAGE_USERS = (ADMIN,)

# Modificar cuentas de banco
CAN_MANAGE_BANKS_ACCOUNTS = (ADMIN, CARTERA)

# Ver cuentas de bancos
CAN_VIEW_BANKS_ACCOUNTS = (CARTERA, ADMIN, CLIENT_ROLES)